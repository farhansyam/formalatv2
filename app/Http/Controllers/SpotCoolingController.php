...
class SpotCoolingController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(SpotCooling $SpotCooling)
    {
        $SpotCooling = SpotCooling::findOrFail(); // Sesuaikan dengan model SpotCooling
        return view('equipment.SpotCooling.show', compact('SpotCooling'));
    }
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(SpotCooling $SpotCooling)
    {
        $SpotCooling = SpotCooling::findOrFail(); // Sesuaikan dengan model SpotCooling
        return view('equipment.SpotCooling.edit', compact('SpotCooling'));
