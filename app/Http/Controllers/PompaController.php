...
class PompaController extends Controller
{
     ...
     */
     ...
     public function create($id)
     {
         ...
         return view('equipment.Pompa.create', compact('id'));
     }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $Pompa = Pompa::create($qData);

        // Pastikan $request->id_equipment tidak null sebelum menyimpan ke dalam tabel History
            $history = new History();
            $history->type = "Pompa"; // Sesuaikan dengan jenis equipment
            $history->id_act = $Pompa->id;
     ...
     *
     * @param  \App\Models\Pompa  $Pompa
     * @return \Illuminate\Http\Response
     */
    public function show(Pompa $Pompa)
    {
        $Pompa = Pompa::findOrFail(); // Sesuaikan dengan model Pompa
        return view('equipment.Pompa.show', compact('Pompa'));
    }
    /**
    ...
    {
        $Pompa = Pompa::findOrFail(); // Sesuaikan dengan model Pompa
        return view('equipment.Pompa.edit', compact('Pompa'));
