...
class AHUController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(AHU $AHU)
    {
        $AHU = AHU::findOrFail(); // Sesuaikan dengan model AHU
        return view('equipment.AHU.show', compact('AHU'));
    }
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AHU $AHU)
    {
        $AHU = AHU::findOrFail(); // Sesuaikan dengan model AHU
        return view('equipment.AHU.edit', compact('AHU'));
