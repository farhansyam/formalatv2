...
class WaterMistController extends Controller
{
    /**
     ...
     */
     ...
     public function create($id)
     {
         ...
         return view('equipment.WaterMist.create', compact('id'));
     }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $WaterMist = WaterMist::create($qData);

        // Pastikan $request->id_equipment tidak null sebelum menyimpan ke dalam tabel History
            $history = new History();
            $history->type = "Water Mist"; // Sesuaikan dengan jenis equipment
            $history->id_act = $WaterMist->id;
     ...
     *
     * @param  \App\Models\WaterMist  $WaterMist
     * @return \Illuminate\Http\Response
     */
    public function show(WaterMist $WaterMist)
    {
        $WaterMist = WaterMist::findOrFail(); // Sesuaikan dengan model WaterMist
        return view('equipment.WaterMist.show', compact('WaterMist'));
    }
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(WaterMist $WaterMist)
    {
        $WaterMist = WaterMist::findOrFail(); // Sesuaikan dengan model WaterMist
        return view('equipment.WaterMist.edit', compact('WaterMist'));
