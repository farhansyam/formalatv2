...
class DehumidifierController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Dehumidifier $Dehumidifier)
    {
        $Dehumidifier = Dehumidifier::findOrFail(); // Sesuaikan dengan model Dehumidifier
        return view('equipment.Dehumidifier.show', compact('Dehumidifier'));
    }
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Dehumidifier $Dehumidifier)
    {
        $Dehumidifier = Dehumidifier::findOrFail(); // Sesuaikan dengan model Dehumidifier
        return view('equipment.Dehumidifier.edit', compact('Dehumidifier'));
