...
class AcSplitController4 extends Controller
{
    /**
    ...
    public function create2($id)
    {
        ...
        return view('equipment.AcSplit4.create', compact('id', 'equipment', 'schedule'));
    }
    ...
    public function show($id)
    {
        ...
        return view('Equipment.AcSplit4.show', compact('acs', 'gambar', 'gambar2', 'id'));
    }
    ...
    public function edit($id)
    {
        ...
        $gambar = GambarAct::where('id_act', $history->id_act)->get();
        $gambar2 = GambarAct2::where('id_act', $history->id_act)->get();
        return view('Equipment.AcSplit4.edit', compact('acs', 'gambar', 'gambar2', 'id'));
    }
    ...
    public function print($id)
    {
        ...
        $pdfContent = view('pdf.acs4', ['history' => $history, 'Acs' => $Acs, 'gambar' => $gambar, 'gambar2' => $gambar2, 'equipment' => $equipment])->render();
