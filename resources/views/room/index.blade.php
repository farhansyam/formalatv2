      ...
      <div class="col-12">
        <div class="card">
          <div class="border-bottom title-part-padding">
            <h4 class="card-title mb-0 text-center">Room</h4>
          </div>
            ...
            <table class="table table-striped table-hover table-bordered table no-wrap tablesaw-columntoggle" data-tablesaw-mode="columntoggle" id="example">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="tablesaw-priority-3">{{$data->kode}}</td>
                  <td class="tablesaw-priority-1">
                    <div style="display: flex; align-items: center;">
                      <a href="{{ route('room.edit', $data->id) }}" style="text-decoration: none;">
                        <button class="btn btn-warning">Edit</button>
                      </a>

                      <form action="{{ route('room.destroy', $data->id) }}" method="POST" style="margin-left: 10px;">
                        @csrf
                        @method('DELETE')
