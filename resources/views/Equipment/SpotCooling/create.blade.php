        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('spoot-cooling.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
            ...
            <td	><input type="time" name="end" class="form-control" id=""></td>
                        ...
                        <table class="table table-bordered" id="personelTeamTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <p>Lokasi :</p><input type="text" class="form-control text-center" required name="q1[]" value="">
                                    </td>
                                    <td>
                                        <p>Lokasi :</p><input type="text" class="form-control text-center" required name="q1[]" value="">
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <p>Code Unit :</p><input type="text" class="form-control text-center" required name="q2[]" value="">
                                    </td>
                                    <td>
                                        <p>Code Unit :</p><input type="text" class="form-control text-center" required name="q2[]" value="">
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <p>No Unit :</p><input type="text" class="form-control text-center" required name="q3[]" value="">
                                    </td>
                                    <td>
                                        <p>No Unit :</p><input type="text" class="form-control text-center" required name="q3[]" value="">
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <p>Model : </p><input type="text" class="form-control text-center" required name="q4[]" value="">
                                    </td>
                                    <td>
                                        <p>Model : </p><input type="text" class="form-control text-center" required name="q4[]" value="">
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <p>No Seri :</p><input type="text" class="form-control text-center" required name="q5[]" value="">
                                    </td>
                                    <td>
                                        <p>No Seri :</p><input type="text" class="form-control text-center" required name="q5[]" value="">
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <p>Capacity :</p><input type="text" class="form-control text-center" required name="q6[]" value="">
                                    </td>
                                    <td>
                                        <p>Capacity :</p><input type="text" class="form-control text-center" required name="q6[]" value="">
                                    </td>
                        ...
                        <table class="table table-bordered" id="personelTeamTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q49[]">
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q49[]">
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q49[]">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q50[]">
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q50[]">
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q50[]">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q51[]">
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q51[]">
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q51[]">
                                    </td>
                                </tr>
