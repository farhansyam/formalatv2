...
<div class="container-fluid">
    ...
    <section>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('spoot-cooling.store') }}" method="POST">
                        @csrf
        ...
        <tr>
            <td><input disabled type="date" name="tanggal" required class="form-control" value="{{$SpotCooling->tanggal}}"></td>
            <td><textarea disabled name="enginer_list" id="" cols="60" rows="10">{{$SpotCooling->enginer_list}}</textarea></td>
        </tr>
        <tr>
            <th>Start Time</th>
            <th>Stop Time</th>
        ...
        <tr>
<td><input disabled type="time" class="form-control" name="start" required value="{{$SpotCooling->start}}"></td>
            <td><input disabled type="time" name="end" class="form-control" value="{{$SpotCooling->end}}" id=""></td>
        </tr>
                        ...
                        <table class="table table-bordered" id="personelTeamTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>CaSpotCoolingity :</p><input disabled type="text" class="form-control text-center" required name="q6[]" value="{{$val}}">
                                    </td>
                                    @endforeach
                        ...
                        <table class="table table-bordered" id="personelTeamTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input disabled type="text" class="form-control text-center" value="{{$val}}" required name="q13[]"></td>
                                    @endforeach
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input disabled type="text" class="form-control text-center" value="{{$val}}" required name="q14[]"></td>
                                    @endforeach
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input disabled type="text" class="form-control text-center" value="{{$val}}" required name="q15[]"></td>
                                    @endforeach
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input disabled type="text" class="form-control text-center" required name="q51[]" value="{{$val}}">
                                        @endforeach
                                    </td>
                                </tr>
                            </tbody>
   ...
   <table class="table table-bordered" id="">
        ...
        <tr>
            <td><textarea disabled disabled name="temuan" id="" cols="60" rows="10">{{$SpotCooling->temuan}}</textarea></td>
            <td><textarea disabled disabled name="rekomendasi" id="" cols="60" rows="10">{{$SpotCooling->rekomendasi}}</textarea></td>
        </tr>
        <tr>
