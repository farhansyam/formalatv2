...
<div class="container-fluid">
    ...
    <section>
        ...
        <tr>
            <td><input type="date" name="tanggal_survey" disabled value="{{$acs->tanggal_survey}}" required class="form-control"></td>
            <td><textarea disabled name="enginerlist" id="" cols="60" rows="10">{{$acs->enginerlist}}</textarea></td>
        </tr>
        <tr>
            <th>Start Time</th>
            <th>Stop Time</th>
        ...
        <tr>
<td><input disabled type="time" class="form-control" name="start" value="{{$acs->start}}" required></td>
            <td><input disabled type="time" name="end" class="form-control" value="{{$acs->stop}}" id=""></td>
        </tr>
