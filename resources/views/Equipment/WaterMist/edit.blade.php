...
<div class="container-fluid">
    ...
    <section>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('water-mistt.update',$wm->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
        ...
        <tr>
            <td><input type="date" name="tanggal" required class="form-control" value="{{$wm->tanggal}}"></td>
            <td><textarea name="enginer_list" id="" cols="60" rows="10">{{$wm->enginer_list}}</textarea></td>
        </tr>
        <tr>
            <th>Start Time</th>
            <th>Stop Time</th>
        ...
        <tr>
<td><input type="time" class="form-control" name="start" required value="{{$wm->start}}"></td>
            <td><input type="time" name="end" class="form-control" id="" value="{{$wm->end}}"></td>
        </tr>
                        ...
                        <table class="table table-bordered" id="personelTeamTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>Cawmity :</p><input type="text" class="form-control text-center" required name="q6[]" value="{{$val}}">
                                    </td>
                                    @endforeach
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control text-center" style="width: 100px" required name="q12[]" value="{{$val}}">
                                        @endforeach
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control text-center" required name="q49[]" value="{{$val}}">
                                        @endforeach
                                    </td>
                                    <td>
                                        @foreach (explode(',',$wm->q50) as $val)
                                        <input type="text" class="form-control text-center" required name="q50[]" value="{{$val}}">
                                        @endforeach
                                    </td>
                                </tr>
                            </tbody>
   ...
   <table class="table table-bordered" id="">
        ...
        <tr>
            <td><textarea name="temuan" id="" cols="60" rows="10">{{$wm->temuan}}</textarea></td>
            <td><textarea name="rekomendasi" id="" cols="60" rows="10">{{$wm->rekomendasi}}</textarea></td>
        </tr>
        <tr>
