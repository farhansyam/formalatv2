...
<div class="container-fluid">
    ...
    <section>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{ route('ac-split2.update',$id) }}" id="myForm" method="POST" enctype="multipart/form-data">
                        @method('PUT')
        ...
        <tr>
            <td><input type="date" name="tanggal_survey" value="{{$acs->tanggal_survey}}" required class="form-control"></td>
...
<td><input type="time" class="form-control" name="start" value="{{$acs->start}}" required></td>
            <td><input type="time" name="end" class="form-control" value="{{$acs->stop}}" id=""></td>
                        ...
                        <div class="border-bottom title-part-padding">
                            <h4 class="card-title mb-0 text-center" style="background-color: black;color:white">Task List AC CASSETE</h4>
                        </div>
                        <div class="card-body">
