...
<style>
   .large-icon {
  font-size: 24px; /* Atur ukuran sesuai kebutuhan, contoh: 24px */
}
   table {
            ...
            <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-3" style="display: flex; flex-direction: column; gap: 10px;">
                        ...
                        <input disabled readOnly="true" type="text"  name="name_plate"
   ...
   <tr>
      ...
      <td>
         @if($acs->fotoparameter_before1 != '0')
           ...
           <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotoparameter_before1', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
         @else
            <input type="file" class="form-control text-center" name="fotoparameter_before1">
         @endif
      </td>
      <td>
         @if($acs->fotoparameter_before1 != '0')
            <img src="{{ asset('gambar/'.$acs->fotoparameter_before2) }}" alt="" height="150">
             <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotoparameter_before2', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
         @else
            <input type="file" class="form-control text-center" name="fotoparameter_before2">
         @endif
      </td>
      <td>
         @if($acs->fotoparameter_before3 != '0')
            <img src="{{ asset('gambar/'.$acs->fotoparameter_before3) }}" alt="" height="150">
             <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotoparameter_before3', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
         ...
         @else
            <input disabled type="file" class="form-control text-center"  name="fotoparameter_before3">
         @endif
      </td>
   </tr>
   <tr>
      <td class="text-center">Nilai</td>
      <td><input type="text" class="form-control text-center"  name="parameter_before1" value="{{$acs->parameter_before1}}"></td>
      <td><input type="text" class="form-control text-center"  name="parameter_before2" value="{{$acs->parameter_before2}}"></td>
      <td><input type="text" class="form-control text-center"  name="parameter_before3" value="{{$acs->parameter_before3}}"></td>
   </tr>
</tbody>
...
<table class="table table-bordered" id="personelTeamTable">
   ...
   <tbody>
      <tr>
         ...
         <td class="tg-0lax"style="width: 31%;">Temp (C)</td>
         <td class="tg-0lax">(Psi)</td>
         <td class="tg-0lax">Pressure (Psi)</td>
      </tr>
   </tbody>
         ...
         <td>
            @if($acs->fotoparameter_after1 != '0')
               <img src="{{ asset('gambar/'.$acs->fotoparameter_after1) }}" alt="" height="150">
                 <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotoparameter_after1', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
            ...
            @else
               <input type="file" class="form-control text-center" 
                                 name="fotoparameter_after1">
            @endif
         </td>
         <td>
            @if($acs->fotoparameter_after2 != '0')
               <img src="{{ asset('gambar/'.$acs->fotoparameter_after2) }}" alt="" height="150">
               <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotoparameter_after2', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
            ...
            @else
               <input type="file" class="form-control text-center" 
                                 name="fotoparameter_after2">
            @endif
         </td>
         <td>
            @if($acs->fotoparameter_after3 != '0')
               <img src="{{ asset('gambar/'.$acs->fotoparameter_after3) }}" alt="" height="150">
                   <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotoparameter_after3', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
            ...
            @else
               <input type="file" class="form-control text-center" 
                                 name="fotoparameter_after3">
            @endif
         </td>
      </tr>
      <tr>
         <td class="text-center">Nilai</td>
         <td><input type="text" style="" class="form-control text-center" name="parameter_after1" value="{{$acs->parameter_after1 }}"></td>
         <td><input type="text" class="form-control text-center" name="parameter_after2" value="{{$acs->parameter_after2 }}"></td>
         <td><input type="text" class="form-control text-center" name="parameter_after3" value="{{$acs->parameter_after3 }}"></td>
      </tr>
   </tbody>
</table>
         ...
         <td>
            @if($acs->fotokomponen_beforr1 != '0')
               <img src="{{ asset('gambar/'.$acs->fotokomponen_beforr1) }}" alt="" height="150">
                   <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotokomponen_beforr1', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
            ...
            @else
              <input type="file" class="form-control text-center" 
                                 name="fotokomponen_beforr1">
            @endif
         </td>
         <td>
            @if($acs->fotokomponen_befor2 != '0')
               <img src="{{ asset('gambar/'.$acs->fotokomponen_befor2) }}" alt="" height="150">
                  <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotokomponen_befor2', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
            ...
            @else
               <input type="file" class="form-control text-center" 
                                 name="fotokomponen_befor2">
            @endif
         </td>
         <td>
            @if($acs->fotokomponen_befor3 != '0')
               <img src="{{ asset('gambar/'.$acs->fotokomponen_befor3) }}" alt="" height="150">
                   <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotokomponen_befor3', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
         ...
         <td>
            @if($acs->fotokomponen_after1 != '0')
               <img src="{{ asset('gambar/'.$acs->fotokomponen_after1) }}" alt="" height="200">
                 <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotokomponen_after1', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
            ...
            @else
             <input type="file" class="form-control text-center" 
                                 name="fotokomponen_after1">
            @endif
         </td>
         <td>
            @if($acs->fotokomponen_after2 != '0')
               <img src="{{ asset('gambar/'.$acs->fotokomponen_after2) }}" alt="" height="200">
                <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotokomponen_after2', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
            @else
                <input type="file" class="form-control text-center" 
                                 name="fotokomponen_after2">
            @endif
         </td>
         <td>
            @if($acs->fotokomponen_after3 != '0')
               <img src="{{ asset('gambar/'.$acs->fotokomponen_after3) }}" alt="" height="200">
                 <a href="{{ route('edit.column', ['table' => 'ac_splits', 'column' => 'fotokomponen_after3', 'id' => $history->id_act]) }}">
            <button class="btn btnm-danger">
               <i class="ti ti-trash large-icon"></i>
            </button>
            </a>
            ...
            @endif
                     ...
                     <table class="table table-bordered" id="">
                        ...
                        <tr>
                           <td>
                              <textarea name="temuan" id="" cols="40" rows="10">{{$acs->temuan}}</textarea>
                           </td>
                           <td>
                              <textarea name="rekomendasi" id="" cols="40" rows="10">{{$acs->temuan}}</textarea>
                           </td>
                           <td>
                              <textarea name="customernote" id="" cols="40" rows="10">{{$acs->customer_note}}</textarea>
                           </td>
                        </tr>
                        <tr>
