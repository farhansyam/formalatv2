                ...
                <div class="col-12">
                    <div class="card">
                        <div class="border-bottom title-part-padding">
                            ...
                            <form action="{{ route('cooling-tower.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <table class="table table-bordered" id="personelTeamTable">
                                    <thead>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <input type="radio" name="intensive" id="" value="Ok">&nbsp;&nbsp;Ok
                                                </td>
                                                <td>
                                                    <input type="radio" name="intensive" id="" value="Not Ok">&nbsp;&nbsp;Not Ok
                                                </td>
                                            </tr>
                                        <tr>
                                            <th>No</th>
