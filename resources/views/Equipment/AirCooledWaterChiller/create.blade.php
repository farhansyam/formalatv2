...
table td, table th {
  ...
  padding: 8px; /* Optional: adds padding for readability */
    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('acwc.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
        ...
        <tr>
            <td><input type="date" name="tanggal_survey" required class="form-control">   <label for="">Jadwal</label>
...
<td><input type="time" class="form-control" name="start" required></td>
            <td><input type="time" name="stop" class="form-control" id=""></td>
                                ...
                                <table class="table table-bordered" id="personelTeamTable" border="5">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Pertanyaan</th>
                                ...
                                <table class="table table-bordered" id="personelTeamTable">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q22[]"></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>Unit Model No :</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q23[]"></td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>Compressor A Serial No :</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q24[]"></td>
                                        </tr>
                                        <tr>
                                            <td>4</td>
                                            <td>Compressor A Model No :</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q25[]"></td>
                                        </tr>
                                        <tr>
                                            <td>5</td>
                                            <td>Compressor B Serial No :</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q26[]"></td>
                                        </tr>

                                        <tr>
                                            <td>6</td>
                                            <td>Compressor B Model No :</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q27[]"></td>
                                        </tr>

                                        <tr>
                                            <td>7</td>
                                            <td>Elevation(°) :</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q28[]"></td>
                                        </tr>

                                        <tr>
                                            <td>8</td>
                                            <td>Nameplate Voltage(V) :</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q29[]"></td>
                                        </tr>

                                        <tr>
                                            <td>9</td>
                                            <td>Fan Motor RLA :</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q30[]"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>10</td>
                                            <td>Des.PSID:</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q31[]"></td>
                                        </tr>

                                        <tr>
                                            <td>11</td>
                                            <td>Des.GPM:</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q32[]"></td>
                                        </tr>

                                        <tr>
                                            <td>12</td>
                                            <td>Act.PSID:</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q33[]"></td>
                                        </tr>

                                        <tr>
                                            <td>13</td>
                                            <td>Act.GPM:</td>
                                            <td><input type="text" placeholder="?" class="form-control text-center"required  name="q34[]"></td>
                                        </tr>
                                    ...
                                    <table class="table table-bordered" id="personelTeamTable">
                                        ...
                                        <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q45[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q45[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q45[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q45[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q45[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q46[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q46[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q46[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q46[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q46[]"></td>
                                              ...
                                              <tr>
                                                <td>Evap EWT</td>
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q47[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q47[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q47[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q47[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q47[]"></td>
                                              ...
                                              <tr>
                                                <td>Evap lwt</td>
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q48[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q48[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q48[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q48[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q48[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q49[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q49[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q49[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q49[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q49[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q50[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q50[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q50[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q50[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q50[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q51[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q51[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q51[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q51[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q51[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q52[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q52[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q52[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q52[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q52[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q53[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q53[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q53[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q53[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q53[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q54[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q54[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q54[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q54[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q54[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q55[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q55[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q55[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q55[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q55[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q56[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q56[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q56[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q56[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q56[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q57[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q57[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q57[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q57[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q57[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q58[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q58[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q58[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q58[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q58[]"></td>
                                              ...
                                              <tr>
                                                <td>Compressor Hours</td>
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q59[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q59[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q59[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q59[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q59[]"></td>
                                              ...
                                              <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q60[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q60[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q60[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q60[]"></td>
                                                <td><input type="text" placeholder="?" class="form-control text-center"required  name="q60[]"></td>
