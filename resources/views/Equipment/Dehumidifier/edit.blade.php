...
<div class="container-fluid">
    ...
    <section>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title mb-0 text-center">Task List Dedehumidifier</h4>
                    </div>
                    <form action="{{ route('dehumidifierr.update',$dehumidifier->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
        ...
        <tr>
            <td><input type="date" name="tanggal" required class="form-control" value="{{$dehumidifier->tanggal}}"></td>
            <td><textarea name="enginer_list" id="" cols="60" rows="10">{{$dehumidifier->enginer_list}}</textarea></td>
        </tr>
        <tr>
            <th>Start Time</th>
            <th>Stop Time</th>
        ...
        <tr>
<td><input type="time" class="form-control" name="start" required value="{{$dehumidifier->start}}"></td>
            <td><input type="time" name="end" class="form-control" id="" value="{{$dehumidifier->end}}"></td>
        </tr>
...
<table class="table table-bordered" id="">
        ...
        <tr>
            <td><textarea   name="temuan" id="" cols="60" rows="10">{{$dehumidifier->temuan}}</textarea></td>
            <td><textarea   name="rekomendasi" id="" cols="60" rows="10">{{$dehumidifier->rekomendasi}}</textarea></td>
        </tr>
        <tr>
            <th>Running Hour</th>
            <th>Job Complete</th>
        ...
        <tr>
            <td><input type="number" name="running_hour" required class="form-control" value="{{$dehumidifier->running_hour}}"></td>

            <td><select  name="status" id="" class="form-select">
                    <option value="{{$dehumidifier->status}}">{{$dehumidifier->status}}</option>
