                              ...
                              <form action="{{ route('troubleshoot.store') }}" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="row">
                                      <div class="col-md-4 mb-3">
                                          ...
                                          <input readOnly="true" readonly type="text" name="customer"
                                              class="form-control" id="" value="{{ $equipment->customer }}"
                                              required="">
                                          <input type="hidden" name="id_equipment" class="form-control" id=""
                                              value="{{ $equipment->id }}" required="">
                                          <label for="">No Kontak</label>
                                          <input type="text" name="no_kontak" class="form-control" id=""
                                              value="" required="">
                                      ...
                                      <div class="col-md-6 mb-3">
                                          ...
                                          <input readonly required type="text" name="serial" class="form-control"
                                              id="" value="{{ $equipment->serial_number }}" required="">
                                      </div>
                                      <div class="col-md-6 mb-3">
                                          <br>
                                  ...
                                  <div class="row">
                                      <div class="col-md-6 mb-3">
                                          ...
                                          <input type="text" name="other_jenis_survey" placeholder="Lainnya"
                                              class="form-control mt-2" id="other_jenis_survey_input"
                                              style="display: none;">
                                      </div>
                                      ...
                                      <div class="col-md-6 mb-3">
                                          ...
                                          <select name="defect_type" class="form-select" id="defect_type">
                                              ...
                                              <option value="Area sulit dijangkau / Hard Access">Area sulit dijangkau /
                                                  Hard Access</option>
                                          ...
                                          <input type="text" name="other_defect_type" placeholder="Lainnya"
                                              class="form-control mt-2" id="other_defect_input" style="display: none;">
                                      </div>
                                  </div>
                                      ...
                                      <div class="col-md-6 mb-3">
                                          <div class="form-check">
                                              <input type="checkbox" name="c1" value="1"
                                                  class="form-check-input" id="invalidcheck1">
                                              <label class="form-check-label" for="invalidcheck1">1. Intensive Safety
                                                  Briefing</label>
                                          </div>
                                          <div class="form-check">
                                              <input type="checkbox" name="c2" value="1"
                                                  class="form-check-input" id="invalidcheck2">
                                              <label class="form-check-label" for="invalidcheck2">2. Memastikan tools
                                                  teknisi memadai</label>
                                          </div>
                                          <div class="form-check">
                                              <input type="checkbox" name="c3" value="1"
                                                  class="form-check-input" id="invalidcheck3">
                                              <label class="form-check-label" for="invalidcheck3">3. Memastikan
                                                  APD&Pernut-JSA lengkap</label>
                                          </div>
                                          <div class="form-check">
                                              <input type="checkbox" name="c4" value="1"
                                                  class="form-check-input" id="invalidcheck4">
                                              <label class="form-check-label" for="invalidcheck4">4. Dokumen penunjang
                                                  memadai(jika dibutuhkan)</label>
                                          </div>
                                      </div>
                                      <div class="col-md-6 mb-3">
                                          <div class="form-check">
                                              <input type="checkbox" name="c5" value="1"
                                                  class="form-check-input" id="invalidcheck5">
                                              <label class="form-check-label" for="invalidcheck5">5. Mencatat data
                                                  equipment</label>
                                          </div>
                                          <div class="form-check">
                                              <input type="checkbox" name="c6" value="1"
                                                  class="form-check-input" id="invalidcheck6">
                                              <label class="form-check-label" for="invalidcheck6">6. Mencatat
                                                  laporan/keluhan teknis user</label>
                                          </div>
                                          <div class="form-check">
                                              <input type="checkbox" name="c7" value="1"
                                                  class="form-check-input" id="invalidcheck7">
                                              <label class="form-check-label" for="invalidcheck7">7. Melakukan survey
                                                  dengan aman,menyeluruh,dan terukur</label>
                                          </div>
                                          <div class="form-check">
                                              <input type="checkbox" name="c8" value="1"
                                                  class="form-check-input" id="invalidcheck8">
                                              <label class="form-check-label" for="invalidcheck8">8. Dokumen Melakukan
                                                  analisa,tindakan,dan rekomendasi</label>
                                          </div>
                                  ...
                                  <h5 class="text-center" style="background-color: black;color:white">Catatan Equipment
                                  </h5>
                                  <div class="row">
                                      ...
                                      <div class="col-md-12 mb-2">
                                          ...
                                          <textarea class="form-control" required name="rekomendasi_teknisi_lapangan" id="" cols="10"
                                              rows="4"></textarea>
                                      </div>
                                  ...
                                  <h5 class="text-center" style="background-color: black;color:white">List Kebutuhan Part
                                      material dan jasa </h5>
                                      ...
                                      <tbody>
                                          ...
                                          <tr>
                                              ...
                                              <td><input required type="text" class="form-control"
                                                      name="deskripsilist[]"></td>
                                              <td><input required type="text" class="form-control" name="modelpart[]">
                                              </td>
                                              <td><input required type="number" class="form-control" name="qty[]">
                                              </td>
                                              <td><input required type="text" class="form-control"
                                                      name="keterangan[]"></td>
                                              <td></td>
                                  ...
                                  <button type="button" class="btn btn-primary" id="addPersonelTeam">Add
                                      List</button><br>
                                  <br>
                                  <table class="table table-bordered" id="">
                                      <tbody>
                                          ...
                                          <tr>
                                              <td>
                                                  <textarea name="temuan" id="" cols="60" rows="10"></textarea>
                                              </td>
                                              <td>
                                                  <textarea name="rekomendasi" id="" cols="60" rows="10"></textarea>
                                              </td>
                                          </tr>
                                          <tr>
                                              <th>Status</th>
                                          ...
                                          <tr>
                                              <td colspan="2"><select onchange="setColor(this);" name="status"
                                  ...
                                  <h5 class="text-center" style="background-color: black;color:white">Tambahkan Foto
                                      Equipment</h5>
                                  <table class="table table-bordered" id="GambarTable">
                                      ...
                                      <tbody>
                                          ...
                                          <tr>
                                              <td>1</td>
                                              <td><input type="file" class="form-control" name="gambar[]" required>
                                              </td>
                                              <td><input type="text" class="form-control" name="info[]" required>
                                              </td>
                                              <td><input type="text" class="form-control" name="keterangan2[]"
                                                      required></td>
