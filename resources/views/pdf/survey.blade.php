    ...
    <table class="MsoNormalTable" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border: none">
      ...
      <tr style="height: 32.3pt">
        <td width="680" colspan="7" valign="top" style="
          ...
          <p class="TableParagraph" align="center" style="
                ...
                text-align: center;
              ">
            <b><span lang="id" style="font-size: 15pt">BERITA<span style="letter-spacing: -0.1pt"> </span>ACARA<span style="letter-spacing: -0.05pt">
                </span>SURVEY<span style="letter-spacing: -0.05pt"> </span>/<span style="letter-spacing: -0.1pt">
                </span>PENGECEKAN</span></b>
          </p>
        </td>
      </tr>
      <tr style="height: 46pt">
        <td width="315" colspan="3" valign="top" style="
          ...
          <p class="TableParagraph" style="
                ...
                line-height: 10.05pt;
              ">
            <span lang="id" style="font-size: 9pt">Customer              : {{$beritaacara->customer}}</span>
          </p>
          <p class="TableParagraph" style="
                margin-top: 0in;
                margin-right: -0.75pt;
          ...
          <p class="TableParagraph" style="
                ...
                line-height: 106%;
              ">
            <span lang="id" style="font-size: 9pt; line-height: 106%">UP / No. Kontak<span style="letter-spacing: 0.05pt"> </span>&nbsp;&nbsp;&nbsp;: {{$beritaacara->no_kontak}}<span style="letter-spacing: -1.9pt"> </span><br>Alamat                 
              <span style="letter-spacing: -0.15pt">: {{$beritaacara->alamat}}</span></span>
          </p>
        </td>
        <td width="170" colspan="2" valign="top" style="
          ...
          <p class="TableParagraph" style="margin-left: 1.95pt; line-height: 10.65pt">
            <span lang="id" style="font-size: 9pt">Engineer<span style="letter-spacing: 0.15pt"> </span>List<span style="letter-spacing: -0.05pt">
              </span>:{{$beritaacara->engineer_list}}</span>
          </p>
        </td>
      ...
      <tr style="height: 11.35pt">
        <td width="680" colspan="7" valign="top" style="
          ...
          <p class="TableParagraph" align="center" style="
                ...
                line-height: 10.4pt;
              ">
            <b><span lang="id" style="font-size: 9pt; color: white">JENIS<span style="letter-spacing: 0.05pt"> </span>SURVEY</span></b>
          </p>
        </td>
      </tr>
      <tr style="height: 23.15pt">
        <td width="680" colspan="7" valign="top" style="
          ...
          <p class="TableParagraph" style="
                ...
                margin-bottom: 0.0001pt;
              ">
            <b><span lang="id" style="font-size: 8pt">@if($beritaacara->jenis_survey == 'new')
                <span style="font-family: DejaVu Sans; font-size: 18px;">&#9745;</span>
                @endif<span style="letter-spacing: -0.25pt"> </span>New<span style="letter-spacing: -0.2pt">
                </span>Install       @if($beritaacara->jenis_survey == 'relokasi')
                <span style="font-family: DejaVu Sans; font-size: 18px;">&#9745;</span>
                @endif<span style="letter-spacing: -0.3pt"> </span>Relokasi/Modiﬁkasi         ⃝<span style="letter-spacing: -0.35pt">
                </span>Audit<span style="letter-spacing: -0.35pt"> </span>Preparation       @if($beritaacara->jenis_survey == 'audit')
                <span style="font-family: DejaVu Sans; font-size: 18px;">&#9745;</span>
                @endif<span style="letter-spacing: -0.4pt">
                </span>Laporan<span style="letter-spacing: -0.45pt"> </span>Trouble        @if($beritaacara->jenis_survey == 'trouble')
                <span style="font-family: DejaVu Sans; font-size: 18px;">&#9745;</span>
                @endif<span style="letter-spacing: -0.2pt"> </span>Lainnya<span style="letter-spacing: -0.2pt"> </span>:</span></b><b><span lang="id" style="font-size: 8pt; letter-spacing: 0.1pt">
              </span></b><u><span lang="id" style="
                    font-size: 8pt;
                    font-family: &quot;Times New Roman&quot;, serif;
                  "> </span></u><u><span lang="id" style="
                    font-size: 8pt;
                    font-family: &quot;Times New Roman&quot;, serif;
                  ">                                  
              </span></u>
      ...
      <tr style="height: 12.35pt">
        <td width="680" colspan="7" valign="top" style="
          ...
          <p class="TableParagraph" align="center" style="
                ...
                line-height: 10.95pt;
              ">
            <b><span lang="id" style="font-size: 9pt; color: white">CATATAN<span style="letter-spacing: 0.3pt"> </span>EQUIPMENT</span></b>
          </p>
        </td>
      </tr>
            ...
            <tr>
              <td style="width: 50%; vertical-align: top; padding: 5px; ">
                <table style="width: 100%;">
                  <tr>
                    <td style="width: 40%; font-size: 9pt;">Jenis Equipment</td>
                    <td style="width: 10%; font-size: 9pt;">:</td>
                    <td style="width: 50%; font-size: 9pt;">{{$beritaacara->jenis_equipment}}</td>
                  </tr>
                  <tr>
                    <td style="width: 40%; font-size: 9pt;">Brand &amp; Model</td>
                    <td style="width: 10%; font-size: 9pt;">:</td>
                    <td style="width: 50%; font-size: 9pt;">{{$beritaacara->brand}}</td>
                  </tr>
                  <tr>
                    <td style="width: 40%; font-size: 9pt;">Serial No.</td>
                    <td style="width: 10%; font-size: 9pt;">:</td>
                    <td style="width: 50%; font-size: 9pt;">{{$beritaacara->serial}}</td>
                  </tr>
                </table>
              </td>
              <td style="width: 50%; vertical-align: top; padding: 5px;">
                <table style="width: 100%;">
                  <tr>
                    <td style="width: 40%; font-size: 9pt;">Name Plate</td>
                    <td style="width: 10%; font-size: 9pt;">:</td>
                    <td style="width: 50%; font-size: 9pt;">{{$beritaacara->name_plate}}</td>
                  </tr>
                  <tr>
                    <td style="width: 40%; font-size: 9pt;">Thn Pembuatan</td>
                    <td style="width: 10%; font-size: 9pt;">:</td>
                    <td style="width: 50%; font-size: 9pt;">{{$beritaacara->tahun_pembuatan}}</td>
                  </tr>
                  <tr>
                    <td style="width: 40%; font-size: 9pt;">Thn Install</td>
                    <td style="width: 10%; font-size: 9pt;">:</td>
                    <td style="width: 50%; font-size: 9pt;">{{$beritaacara->tahun_install}}</td>
                  </tr>
                </table>
              </td>
            </tr>
      ...
      <tr style="height: 10.6pt">
        <td width="680" colspan="7" valign="top" style="
              ...
              height: 10.6pt;
            ">
          <p class="TableParagraph" style="margin-left: 1.5pt; line-height: 9.65pt">
            <span lang="id" style="font-size: 9pt">Deskripsi<span style="letter-spacing: 0.1pt"> </span>/
              Laporan<span style="letter-spacing: 0.1pt"> </span>User<span style="letter-spacing: 0.2pt">
              </span>: {{$beritaacara->deskripsi}}</span>
          </p>
        </td>
      </tr>
      ...
      <tr style="height: 24.65pt">
        <td width="680" colspan="7" valign="top" style="
              ...
              height: 24.65pt;
            ">
          <p class="TableParagraph" style="margin-top: 0.45pt">
            <span lang="id" style="font-family: &quot;Times New Roman&quot;, serif">&nbsp;</span>
          </p>
          <p class="TableParagraph" style="margin-left: 1.5pt; line-height: 10.55pt">
            <span lang="id" style="font-size: 9pt">Analisa<span style="letter-spacing: 0.05pt"> </span>Awal<span style="letter-spacing: 0.05pt">
              </span>: {{$beritaacara->analisa_awal}}</span>
          </p>
        </td>
      </tr>
      <tr style="height: 11pt">
      ...
      <tr style="height: 24.65pt">
        <td width="680" colspan="7" valign="top" style="
          ...
          <p class="TableParagraph" style="margin-left: 1.5pt; line-height: 10.55pt">
            <span lang="id" style="font-size: 9pt">Tindakan : {{$beritaacara->tindakan}}</span>
          </p>
        </td>
      </tr>
      <tr style="height: 11pt">
      ...
      <tr style="height: 24.65pt">
        <td width="680" colspan="7" valign="top" style="
          ...
          <p class="TableParagraph" style="margin-left: 1.5pt; line-height: 10.55pt">
            <span lang="id" style="font-size: 9pt">Rekomendasi<span style="letter-spacing: 0.05pt"> </span>Teknisi<span style="letter-spacing: 0.1pt"> </span>Lapangan<span style="letter-spacing: 0.1pt"> </span>: {{$beritaacara->rekomendasi_teknisi_lapangan}}</span>
          </p>
        </td>
      </tr>
      <tr style="height: 11pt">
    ...
    <p class="MsoBodyText">
      <span style="
          ...
          "><span style="
            ...
            width: 222px;
            height: 1px;
          "><span lang="id">Keterangan<span style="letter-spacing: -0.2pt"> </span>:<span style="letter-spacing: -0.25pt">
                </span>Lembar<span style="letter-spacing: -0.15pt"> </span>1<span style="letter-spacing: -0.25pt">
                </span>untuk<span style="letter-spacing: -0.15pt"> </span>Teknisi;<span style="letter-spacing: -0.25pt">
                </span>Lembar<span style="letter-spacing: -0.2pt"> </span>2<span style="letter-spacing: -0.25pt">
                </span>untuk<span style="letter-spacing: -0.15pt"> </span>User;<span style="letter-spacing: -0.25pt">
                </span>Lembar<span style="letter-spacing: -0.15pt"> </span>3<span style="letter-spacing: -0.25pt">
                </span>Arsip<span style="letter-spacing: -0.25pt"> </span>Kantor</span>
    </p>
  </div>
