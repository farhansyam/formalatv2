      ...
      <td width="146" valign="top" style="
        ...
        <p class="TableParagraph">
          <span lang="id" style="
                                    font-size: 12pt;
                                    font-family: &quot;Times New Roman&quot;, serif;
                                "><br><br><img width="" height="100" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('gambar/') . $g1->gambar)) }}" />
          </span>
        </p>
      </td>
      <td width="125" valign="top" style="
      ...
      <td width="146" valign="top" style="
        ...
        <p class="TableParagraph">
          <span lang="id" style="
                                    font-size: 12pt;
                                    font-family: &quot;Times New Roman&quot;, serif;
                                "><br><br><img width="" height="100" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('gambar/') . $g2->gambar)) }}" />
          </span>
        </p>
      </td>
      <td width="125" valign="top" style="
