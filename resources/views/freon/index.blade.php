      ...
      <div class="col-12">
        <div class="card">
          <div class="border-bottom title-part-padding">
            <h4 class="card-title mb-0 text-center">Freon Type</h4>
          </div>
          <script src="{{asset('dist/libs/jquery/dist/jquery.min.js')}}"></script>
          <div class="card-body">
            <a href="{{route('freon.create')}}">
            ...
            <table class="table table-striped table-hover table-bordered table no-wrap tablesaw-columntoggle" data-tablesaw-mode="columntoggle" id="example">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="tablesaw-priority-3">{{$data->jenis_freon}}</td>
                  <td class="tablesaw-priority-1">
                    <div style="display: flex; align-items: center;">
                      <a href="{{ route('freon.edit', $data->id) }}" style="text-decoration: none;">
                        <button class="btn btn-warning">Edit</button>
                      </a>

                      <form action="{{ route('freon.destroy', $data->id) }}" method="POST" style="margin-left: 10px;">
                        @csrf
                        @method('DELETE')
