          ...
          <ul id="sidebarnav">
           ...
           @if(auth()->user()->role_sipm == 'spv' || auth()->user()->role_sipm == 'team_lead')
            ...
            @if (auth()->user()->akses == 4)
             <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('equipment.exportindex')}}" aria-expanded="false">
                <span>
        ...
        <header class="app-header"> 
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="d-block d-lg-none">
              ...
              <img src="../../dist/images/logos/light-logo.svg" class="light-logo" width="180" alt="" style="display: none;">
            </div>
